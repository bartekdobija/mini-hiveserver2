...
public abstract class AbstractHiveService {
  ...
  private final List<String> addedProperties = new ArrayList<String>();
  
  public AbstractHiveService(final HiveConf hiveConf, final String hostname,
      final int binaryPort, final int httpPort) {
   ...
   * @return
   */
  public String getConfProperty(final String propertyKey) {
   ...
   * @param propertyValue
   */
  public void setConfProperty(final String propertyKey,
  ...
  public void setWareHouseDir(final String wareHouseURI) {
    verifyNotStarted();
   ...
   * @param portNum
   */
  public void setBinaryPort(final int portNum) {
    binaryPort = portNum;
  }
   ...
   * @param portNum
   */
  public void setHttpPort(final int portNum) {
    httpPort = portNum;
  }
  ...
  protected void setStarted(final boolean hiveServiceStatus) {
    startedHiveService = hiveServiceStatus;
  }
